...
<ism:modeHelper mapName="mm" wcmmodeName="mo"/><%
%><c:if test="${mm.EDIT}"><%
...
<br/>
	...
	<br/>
    <b>Basic Text - getValidInteger:</b> ${isx:getValidInteger(m.basictext, -1, pageContext)} 
	<br/>
	<b>Basic Text - getValidJSToken:</b> ${isx:getValidJSToken(m.basictext, "", pageContext)}	
</p>
