...
public class SimpleCacheConfigurationImpl implements SimpleCacheConfiguration {
    ...
    @Property(label = "Enable Cache Statistics", 
    		...
    		boolValue = SimpleCacheService.DEFAULT_CACHE_STATS_ENABLED)
	...
	protected void activate(ComponentContext ctx) {
		...
		this.specs = PropertiesUtil.toString(props.get(PROPERTY_CACHE_SPECFICIATIONS), SimpleCacheService.DEFAULT_CACHE_SPECFICIATIONS);
		this.statsEnabled = PropertiesUtil.toBoolean(props.get(PROPERTY_CACHE_STATS_ENABLED), SimpleCacheService.DEFAULT_CACHE_STATS_ENABLED);
